...
class SciHub(object):
    ...
    def _get_available_scihub_urls(self):
        ...
        '''
       #'http://sci-hub.ren','http://sci-hub.wf' ,'https://sci-hub.ren','https://sci-hub.wf' ,'http://sci-hub.ee' ,'https://sci-hub.ee ','https://sci-hub.click','https://sci-hub.cat'
        urls = []
    ...
    @retry(wait_random_min=3500, wait_random_max=10000, stop_max_attempt_number=10)
